...
class MLP(nn.Module):
    ...
    def __init__(self):
        ...
        self.output3 = nn.Linear(HIDDEN2, 10)
...
def train(train_dataset):
    ...
    torch.save(model.state_dict(), './model/level1_model.pth')   #保存数据
...
#绘制损失曲线图像
    ...
    save_path = os.path.join(DRAW_DIR, 'MLP_DRAW.png')
...
def evaluate(test_dataset):
    ...
    model.load_state_dict(torch.load('./model/level1_model.pth',map_location=device))
