...
def train(train_dataset):
    ...
    torch.save(model.state_dict(), './model/level1_model_2.pth')   #保存数据
...
#绘制损失曲线图像
    ...
    save_path = os.path.join(DRAW_DIR, 'MLP_DRAW_2.png')
...
def evaluate(test_dataset):
    ...
    model.load_state_dict(torch.load('./model/level1_model_2.pth',map_location=device))
